...
class DataPermissionInterceptorTest {
     ...
     */
    private static final Map<String, String> sqlSegmentMap = new HashMap<String, String>() {
        {
    ...
    private static final DataPermissionInterceptor interceptor = new DataPermissionInterceptor(new DataPermissionHandler() {
        @Override
